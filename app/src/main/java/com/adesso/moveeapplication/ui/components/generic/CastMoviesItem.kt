...
import com.adesso.moveeapplication.ui.components.holder.RecyclerCastMoviesRowHolder
 ...
 */
class CastMoviesItem(val item: Movie) : GenericItem(), Serializable {
    ...
    override fun getRowHolderView(
        ...
        val binding =
            DataBindingUtil.inflate<ViewDataBinding>(
                inflater,
                R.layout.recycler_item_cast_movie,
                parent,
                false
            )
        return RecyclerCastMoviesRowHolder(binding, listener)
    }
